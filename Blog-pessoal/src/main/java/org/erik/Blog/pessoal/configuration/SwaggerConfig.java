package org.erik.Blog.pessoal.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.erik.Blog.pessoal.controller"))
	...
	private static Contact contact() {
		return new Contact("Erik Greff", "https://github.com/ERIK-GREFF", "erikgreff5@gmail.com");
	}
